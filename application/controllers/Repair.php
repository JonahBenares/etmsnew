...
class Repair extends CI_Controller {
    ...
    public function repair_form(){  
        ...
        $data['et_head']=$this->super_model->custom_query("SELECT * FROM et_head eh INNER JOIN et_details ed ON eh.et_id = ed.et_id WHERE eh.et_id NOT IN (SELECT et_id FROM repair_details WHERE method='1' AND remove_upgrade='0') AND accountability_id='$accountable' AND damage='0' AND save_temp='0' ORDER BY et_desc ASC");
