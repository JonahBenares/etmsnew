                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 offset-lg-2">
                                <div class="btn-group pull-right">
                                    ...
                                    <?php if(!empty($filt)){ ?>
                                        <a href = "<?php echo base_url(); ?>report/export_overall/<?php echo $from;?>/<?php echo $to;?>/<?php echo $category;?>/<?php echo $subcat;?>/<?php echo $department;?>/<?php echo $item;?>/<?php echo $brand;?>/<?php echo $model;?>/<?php echo $item_type;?>/<?php echo $serial_no;?>/<?php echo $damage;?>/<?php echo $condition;?>/<?php echo $plac;?>/<?php echo $company;?>" class="btn btn-sm btn-warning-alt pull-right" style ="color:white;"><span class="fa fa-report"></span>Export to Excel</a>

                                        <a href = "<?php echo base_url(); ?>report/report_print_overall/<?php echo $from;?>/<?php echo $to;?>/<?php echo $category;?>/<?php echo $subcat;?>/<?php echo $department;?>/<?php echo $item;?>/<?php echo $brand;?>/<?php echo $model;?>/<?php echo $item_type;?>/<?php echo $serial_no;?>/<?php echo $damage;?>/<?php echo $condition;?>/<?php echo $plac;?>/<?php echo $company;?>" class="btn btn-sm btn-info-alt pull-right"><span class="fa fa-print"></span> Print</a>
                                    <?php }else { ?>
