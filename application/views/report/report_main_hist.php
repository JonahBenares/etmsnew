                    ...
                    <div class="card-body">                        
                        ...
                        <table class="table table-borderless table-striped table-earning table-hover" id="myTable_peret">
                            ...
                            <tbody>
                                ...
                                <tr >
                                    <td>
                                        <a href="<?php echo base_url(); ?>index.php/report/history_view/<?php echo $det['ed_id']; ?>" target="_blank" class="" data-toggle="tooltip" data-placement="right" title="View"  style="white-space: normal!important;text-align: left">
                                                <?php echo $i['item']; ?>
                                        </a>                                            
                                    </td>
