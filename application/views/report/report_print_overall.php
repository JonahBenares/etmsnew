...
<div class="main-contdent" >
    <div>
        <div  style="position: fixed;width: 100%;top: 0" id="btn_print" >
            <center>
                <a class="btn btn-lg btn-warning-alt text-white" href = '<?php echo base_url(); ?>index.php/report/inv_rep_overall'  style="width:5%"><span class="fa fa-chevron-left"></span></a>
