...
<div class="main-contdent" >
    <div>
        <div  style="position: fixed;width: 100%;top: 0" id="btn_print" >
            <center>
                <a class="btn btn-lg btn-warning-alt text-white" href = '<?php echo base_url(); ?>index.php/report/report_main_avail'  style="width:5%"><span class="fa fa-chevron-left"></span></a>
