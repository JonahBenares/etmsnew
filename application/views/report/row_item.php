...
<?php for($x=0;$x<$upgrade['count'];$x++){ ?>

    <tr id='item_row1'>  
    <td class="main-tab" align="center"><?php echo $upgrade['acn']; ?></td>
     <td class="main-tab" align="center"><input type = "text" name = "acq_date<?php echo $upgrade['count']?>" style = "text-align:center;width:100%;border:1px transparent;" value="<?php echo $upgrade['acq_date']; ?>"></td>
    ...
    <td class = "hid"><center>
        <a class="btn btn-danger-alt btn-sm text-white" onclick="remove_item(<?php echo $upgrade['count']; ?>)"><span class=" fa fa-times"></span></a></center>
