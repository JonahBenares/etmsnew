                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" width = "10%">
                                            <div class="btn-group">
                                                <a href = '<?php echo base_url(); ?>index.php/report/rem_set/<?php echo $s['ed_id'];?>/<?php echo $id;?>' class="btn btn-danger-alt item btn-sm text-white" data-toggle="tooltip" onclick="confirmationDeleteSet(this);return false;" data-placement="top" title="Remove Set">
                                                    <i class="fa fa-times"></i>
                                                </a>
                                                <a href = '<?php echo base_url(); ?>index.php/report/create_set/<?php echo $s['employee_id'];?>/<?php echo $s['ed_id'];?>' class="btn btn-info-alt item btn-sm text-white" data-toggle="tooltip" data-placement="top" title="Update Set">
